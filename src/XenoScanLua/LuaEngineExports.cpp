...
LUAENGINE_EXPORT_VALUE(int32_t, SCAN_VARIANT_FILETIME64,                 ScanVariant::SCAN_VARIANT_FILETIME64);
LUAENGINE_EXPORT_VALUE(int32_t, SCAN_VARIANT_TICKTIME32,                 ScanVariant::SCAN_VARIANT_TICKTIME32);
